...
def build_vgg16_model(is_training, images, params):
    """
    ...
    def max_pool_2x2(conv):
        return tf.nn.max_pool2d(conv, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')
    #===================================================
...
def vgg16_model_fn(features, labels, mode, params):
    ...
    with tf.compat.v1.variable_scope('model'):
        embeddings = build_vgg16_model(is_training, images, params)
