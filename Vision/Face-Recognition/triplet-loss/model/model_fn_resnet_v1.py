...
def build_resnet_v1_model(is_training, images, params, reuse=None, scope='InceptionResnetV1'):
    ...
    """  
    with tf.variable_scope(scope, 'InceptionResnetV1', [images], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout], is_training=is_training):
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
                ...
                with tf.variable_scope('Logits'):
                    ...
                    net = slim.dropout(net, params.dropout_keep_prob, is_training=is_training, scope='Dropout')
                
                net = slim.fully_connected(net, params.embedding_size, activation_fn=None,  scope='Bottleneck', reuse=False)
  
    return net

def resnet_v1_model_fn(features, labels, mode, params):
    """
    ...
    with tf.variable_scope('model'):
        embeddings = build_resnet_v1_model(is_training, images, params)
